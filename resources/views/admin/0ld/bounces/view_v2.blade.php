                                ...
                                @if(trim($body ?? '') !== '')
                                    ...
                                    @if($bodyType === 'html')
                                        <div class="overflow-auto rounded-2xl border border-slate-200 bg-slate-100 p-4">
                                            <iframe
                                                class="block h-[1400px] w-full min-w-full rounded-xl border border-slate-200 bg-white"
                                                sandbox="allow-same-origin"
                                                srcdoc="{{ $body }}">
                                            </iframe>
                                        </div>
                                    @else
                                        <pre class="overflow-auto whitespace-pre-wrap rounded-2xl border border-slate-200 bg-slate-50 p-4 text-xs text-slate-700">{{ $body }}</pre>
                                    @endif
