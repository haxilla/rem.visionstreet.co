{{-- =========================================
   FREE FLYER CONNECTED UNIT (FORM LEFT)
========================================= --}}
@php
...
<div class="w-full pt-8 pb-10 lg:pt-12 lg:pb-14">
    <div class="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        ...
        <div class="overflow-hidden rounded-[28px] shadow-[0_18px_48px_rgba(0,0,0,.16)]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-[420px_minmax(0,1fr)] items-stretch">

                {{-- LEFT: FORM PANEL (WHITE) --}}
                <div class="bg-white px-6 py-7 sm:px-7 sm:py-8 lg:px-8 lg:py-9">
                    ...
                    <form method="post" action="#" class="space-y-5">
                        ...
                        {{-- NAME --}}
                        <div>
                            <label class="mb-2 block text-[12px] font-semibold uppercase tracking-[0.14em] text-gray-500">
                                Your Name
                            </label>
                            <input
                                type="text"
                ...
                <div class="bg-[#1e3566] px-6 py-8 sm:px-7 sm:py-9 lg:px-10 lg:py-10 flex items-center">
                    ...
                    <div class="max-w-[420px]">
                        ...
                        <h3 class="font-display mt-6 text-[30px] leading-[1.05] text-white">
                            Start With a<br>Free Flyer
                        </h3>

                        <div class="mt-4 h-[2px] w-20 rounded-full" style="background: {{ $brandGold }};"></div>

                        <p class="mt-6 text-[16px] leading-8 text-white/88">
