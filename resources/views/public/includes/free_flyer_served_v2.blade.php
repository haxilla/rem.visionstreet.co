...
<section class="w-full py-10 lg:py-14">
    <div class="mx-auto max-w-[1100px] px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-[340px_minmax(0,1fr)] items-start">
            ...
            {{-- LEFT: TRUST AD CARD --}}
            <div class="overflow-hidden rounded-[28px] bg-white shadow-[0_18px_48px_rgba(0,0,0,.12)]">
                <img
                    src="{{ asset('images/realtyemails-served-thousands.jpg') }}"
                    alt="RealtyEmails has served thousands of agents since 2006"
                    class="block w-full h-auto object-contain object-center bg-white"
                >
            </div>

            {{-- RIGHT: FREE FLYER CARD --}}
            <div class="rounded-[28px] bg-[#1e3566] px-6 py-6 sm:px-7 sm:py-7 lg:px-8 lg:py-8 shadow-[0_20px_55px_rgba(0,0,0,.18)]">
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-[270px_minmax(0,400px)] lg:items-start lg:justify-between">
                    ...
                    <div class="flex flex-col items-start text-left">
                        ...
                        <p class="mt-5 max-w-[260px] text-[16px] leading-8 text-white/88">
                    ...
                    {{-- RIGHT SIDE: FORM --}}
                    <div class="w-full max-w-[400px] lg:ml-auto self-start">
