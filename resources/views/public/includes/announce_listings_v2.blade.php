    ...
    <div class="mx-auto max-w-[1600px] px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 xl:grid-cols-[440px_minmax(0,1fr)] items-start gap-8 lg:gap-12">
            ...
            <div class="relative pt-2">
                <div class="relative mx-auto max-w-[360px] lg:max-w-[390px] xl:max-w-[420px]">
                    <img
                        ...
                        class="block h-auto w-full select-none drop-shadow-[0_22px_40px_rgba(15,23,42,0.14)]"
                    >
                </div>
            ...
            <div class="pt-2">
                ...
                <h2 class="max-w-[13ch] font-serif text-[2.2rem] leading-[1.05] text-[#18233b] sm:text-[2.8rem] lg:text-[3.15rem]">
                    {{ $headline }}
                </h2>
