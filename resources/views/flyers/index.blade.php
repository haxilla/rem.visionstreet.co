  ...
  :class="collapsed ? 'ml-20' : 'ml-64'">
    <div class="mx-3 lg:mx-10">
        <div class="pageswap p-0 lg:p-6 w-full">
            ...
            {{-- Sticky Action Bar --}}
            <div class="fixed top-[72px] left-0 right-0 z-40 -mx-4 mb-8 border-b border-slate-300 bg-slate-100/95 px-4 py-3 backdrop-blur">
            ...
            <div class="mt-14 mb-4 border border-gray-200 rounded-xl bg-white shadow-sm overflow-hidden mx-auto"
